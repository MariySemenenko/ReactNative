...
import {
    ...
    View,
    StyleSheet,
    TouchableOpacity,//Для реалізації кнопок
    Image,//Для відображення вибраної фотографії
    TextInput,//Для вводу назви та місцевості фото
    TouchableWithoutFeedback,//Для закриття клавіатури при натисканні поза полями вводу
    Keyboard,//Для закриття клавіатури при натисканні поза полями вводу
  } from "react-native";
  import React, { useState, useEffect } from "react";
  import { Camera } from "expo-camera";// Для взаємодії з камерою пристрою
  import { MaterialIcons, Feather } from "@expo/vector-icons";
  import * as Location from "expo-location";//Для отримання геолокації
  import * as ImagePicker from "expo-image-picker";//Для вибору фотографій з галереї
  ...
  //Коли користувач натискає кнопку "Опублікувати", він переходить на екран "Публікації"
